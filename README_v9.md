# Interactive Regression Analysis - v9
...
- the estimated **X opt** from the fitted curve
...
## Run
```bash
streamlit run streamlit_regression_dual_r2_v9.py
```
...
- Use the regression and **X opt** as an **interpolated estimate** between tested concentrations.
...
- The graph includes the estimated **Max reg / X opt** based on the fitted curve.
